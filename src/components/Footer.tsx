...
export function Footer() {
  return <footer className="footer">
    <div className="container footer-grid">
      <div><Image className="footer-logo" src="/images/yasashisa/yasashisa-wordmark.jpg" alt="やさしさ 昭島東中神整骨院" width={454} height={124} /><p>{siteConfig.address}</p><p>東中神駅南口から徒歩4分</p></div>
